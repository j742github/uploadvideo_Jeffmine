      ...
      <div className="main-content">
        ...
        <div className="collections">
          <div className="collection">
            ...
            <div className="collection-title">28-Days Weight Loss Challenge</div>
            <div className="collection-info">
              Tom | 1 hour ago | 2 Views</div>
          </div>
          <div className="collection">
          ...
          <div className="collection">
            ...
            <div className="collection-title">28 Day Workout to Lose Fat Challenge</div>
          ...
          <div className="collection">
            <img src={"clouddatachallenge.jpg"} alt="Learn to Earn Cloud Data" />
            <div className="collection-title">Learn to Earn Cloud Data</div>
...
{/*pagination*/}
<div className="pagination" style={{ float: 'right', marginRight: '100px' }}>
<a href="#">1</a>
  ...
  <a href="#">3</a>
  <span style={{ margin: '0 5px' }}></span>
  <button style={{ backgroundColor: '#f0f0f0', border: '1px solid #ccc' }}>&gt;</button>
</div>
{/*end of pagination*/}
